...
public class Swerve extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private final PIDController pathXController = new PIDController(10, 0, 0, 0);
    private final PIDController pathYController = new PIDController(10, 0, 0, 0);
    private final PIDController pathThetaController = new PIDController(7, 0, 0, 0);
